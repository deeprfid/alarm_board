...
static osMutexId_t tb_BufMux;
static osRtxMutex_t gTb_BufMux_cb;

//#define MaxTagBytesBufferLen (1024*8)

static int tb_IsRecHighestRssi = 0;
static int tb_IsUniByAnt = 0;
static int tb_IsUniByEmdData = 0;
static int tb_IsUseMutex = 1;
static unsigned char *tb_pTags;
static unsigned int tb_ReadIndex;
static unsigned int tb_PeekIndex;
static volatile unsigned int tb_WriteIndex;
static volatile unsigned int tb_MaxTagCount;
static int tb_ItemLen;
static unsigned short *tb_pTagIndexHeaders;
