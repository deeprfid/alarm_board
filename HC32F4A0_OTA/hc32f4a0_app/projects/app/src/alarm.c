...
//static osThreadId_t ThreadIdTaskFlashDB  = NULL;
//static osThreadId_t ThreadIdTask_Monitor = NULL;
...
void AppTaskCreate(void)
{
    ...
    osThreadNew(Task_Monitor, NULL, &Task_Monitor_Attr);
    osThreadNew(FlashDB_Task, NULL, &ThreadDB_Attr);
}
