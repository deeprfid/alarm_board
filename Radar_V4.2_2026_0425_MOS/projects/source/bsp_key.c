...
#define KEY_COUNT   	 	HARD_KEY_NUM //(HARD_KEY_NUM + 2)	/* 8个独立建 + 2个组合按键 */
...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
	{GPIO_PORT_C, GPIO_PIN_14 , 1},		/* K1 */
  {GPIO_PORT_C, GPIO_PIN_13 , 1},		/* K2 */
	{GPIO_PORT_H, GPIO_PIN_02 , 1},		/* K3 */
};	
...
static uint8_t KeyPinActive(uint8_t _id)
{
	...
	if (GPIO_ReadInputPins(s_gpio_list[_id].u8Port ,s_gpio_list[_id].pin) == 0)
	{
		level = 0;
	}
	else
...
static void bsp_InitKeyHard(void)
{	
//	{GPIO_PORT_C, GPIO_PIN_14 , 0},		/* K1 */
//  {GPIO_PORT_C, GPIO_PIN_13 , 0},		/* K2 */
//	{GPIO_PORT_H, GPIO_PIN_02 , 0},		/* K3 */
